...
function mainPageHTML() {
  return modernMainPageHTML();
  return `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="theme-color" content="#07111d"><title>Maqtomate — Managed WhatsApp AI Employee</title><style>:root{--bg:#07111d;--panel:#0e1b2b;--line:#ffffff18;--mint:#8ff3d8;--ink:#edf6fb;--muted:#a9b9c9}*{box-sizing:border-box}body{margin:0;background:radial-gradient(circle at 8% 0,#16445a88,transparent 31%),radial-gradient(circle at 92% 18%,#0e725d44,transparent 24%),var(--bg);color:var(--ink);font-family:Inter,system-ui,sans-serif}.nav,.wrap{max-width:1180px;margin:auto;padding:0 22px}.nav{height:70px;display:flex;align-items:center;justify-content:space-between}.brand{font-weight:850}.nav a{color:#c8fbed;text-decoration:none;font-size:13px;font-weight:750}.button{display:inline-flex;padding:12px 16px;border-radius:10px;background:linear-gradient(135deg,#9af4db,#31d8bb);color:#063127!important}.hero{padding:90px 0 64px}.grid{display:grid;grid-template-columns:1.1fr .9fr;gap:20px}.eyebrow{color:var(--mint);font-size:10px;font-weight:850;letter-spacing:.16em;text-transform:uppercase}.hero h1{font-size:clamp(48px,7vw,82px);line-height:.92;letter-spacing:-.08em;margin:14px 0}.hero h1 em{font-style:normal;color:var(--mint)}p{color:var(--muted);line-height:1.65}.card{border:1px solid var(--line);border-radius:18px;padding:22px;background:linear-gradient(145deg,#11263a,#091320)}.card h2{margin:6px 0;font-size:22px}.steps{display:grid;gap:10px;margin-top:18px}.steps div{padding:12px;border-radius:10px;background:#06111ddd;color:#c6d7e6;font-size:12px}.steps b{color:var(--mint);margin-right:7px}.section{padding:64px 0;border-top:1px solid var(--line)}.section h2{font-size:clamp(30px,5vw,52px);line-height:1;letter-spacing:-.06em;max-width:780px}.cards{display:grid;grid-template-columns:repeat(3,1fr);gap:12px;margin-top:22px}.cap{border:1px solid var(--line);border-radius:14px;padding:18px;background:#0c1725}.cap span{color:var(--mint);font-size:10px;font-weight:800}.cap h3{margin:18px 0 6px;font-size:16px}.cap p{font-size:12px}.price{color:#b9ffe8;font-weight:800}.actions{display:flex;gap:10px;flex-wrap:wrap;margin-top:22px}.ghost{border:1px solid #8ff3d855;padding:11px 15px;border-radius:10px}.foot{padding:28px 0 40px;color:#71859b;font-size:11px}@media(max-width:780px){.grid,.cards{grid-template-columns:1fr}.hero{padding-top:55px}.nav,.wrap{padding-left:15px;padding-right:15px}}</style></head><body><header class="nav"><div class="brand">Maqtomate</div><div><a href="/pricing">Pricing</a> &nbsp; <a href="/login">Sign in</a> &nbsp; <a class="button" href="/connect">Plan rollout</a></div></header><main><section class="hero"><div class="wrap grid"><div><span class="eyebrow">Official WhatsApp Cloud API · managed deployment</span><h1>Your WhatsApp AI Employee can <em>work with your team.</em></h1><p>Maqtomate helps businesses prepare customer enquiries, qualify leads, preserve context for human handoff, and activate official WhatsApp operations through a secure managed rollout.</p><div class="actions"><a class="button" href="/connect">Plan your AI Employee</a><a class="ghost" href="/signup">Create customer account</a></div></div><aside class="card"><span class="eyebrow">Customer activation command center</span><h2>A real journey, not a fake demo.</h2><div class="steps"><div><b>01</b>Google identity and customer password</div><div><b>02</b>Offer choice, payment review and readiness</div><div><b>03</b>Customer-owned official connection</div><div><b>04</b>Supervised go-live proof and tenant workspace</div></div></aside></div></section><section class="section"><div class="wrap"><span class="eyebrow">Managed offers</span><h2>Know the price before activation.</h2><div class="cards"><article class="cap"><span>01 · MANAGED LAUNCH</span><h3 class="price">Rs 5,000 setup + Rs 2,000/month</h3><p>Approved business context, qualification rules, human handoff design, and supervised readiness testing.</p></article><article class="cap"><span>02 · CUSTOM BUSINESS ROLLOUT</span><h3>Quote after review</h3><p>For higher volume, additional languages, complex workflows, or separately approved integrations.</p></article><article class="cap"><span>ACTIVATION BOUNDARY</span><h3>Managed and owner-approved</h3><p>Payment starts review. It does not promise an instant bot, shared owner account, or unverified integration.</p></article></div><div class="actions"><a class="button" href="/pricing">View pricing</a></div></div></section><section class="section"><div class="wrap"><span class="eyebrow">Expansion with control</span><h2>More capability, only when it is safe for your tenant.</h2><p>WhatsApp-first today. Customer workspace, CRM, spreadsheet, social-channel, voice and workflow expansion are gated behind verified, tenant-scoped server-side connections.</p><div class="cards"><article class="cap"><span>NOW</span><h3>Official WhatsApp</h3><p>Managed Cloud API rollout, tenant isolation, Gemini policy and human handoff.</p></article><article class="cap"><span>GATED</span><h3>Customer workspace</h3><p>Conversation, lead, knowledge, team and usage surfaces appear only when verified.</p></article><article class="cap"><span>FUTURE CONNECTORS</span><h3>CRM, Sheets, channels and voice</h3><p>Only named, customer-approved server-side adapters. No shared accounts, browser keys or unsupported claims.</p></article></div></div></section></main><footer class="wrap foot">© ${new Date().getFullYear()} Maqtomate · Managed WhatsApp AI Employee · <a href="/security">Security</a> · <a href="/login">Customer sign in</a></footer></body></html>`;
}

function modernMainPageHTML() {
  return `<!doctype html><html><head><meta name="viewport" content="width=device-width,initial-scale=1"><style>:root{--n:#090a12;--p:#13152a;--t:#eaf0ff;--m:#a8b0cf;--a:#8b5cf6;--c:#2dd4bf}*{box-sizing:border-box}body{margin:0;background:radial-gradient(circle at 82% 5%,#6d28d955,transparent 28%),radial-gradient(circle at 15% 25%,#14b8a633,transparent 23%),var(--n);color:var(--t);font:15px Inter,system-ui}.wrap{max-width:1180px;margin:auto;padding:0 24px}.nav{height:74px;display:flex;align-items:center;justify-content:space-between}.brand{font-weight:900;letter-spacing:-.06em}.nav a{color:var(--t);text-decoration:none;margin-left:18px;font-size:13px}.btn{display:inline-flex;padding:12px 16px;border-radius:999px;background:linear-gradient(135deg,var(--a),var(--c));color:#071019!important;font-weight:850}.hero{padding:82px 0 70px}.grid{display:grid;grid-template-columns:1.05fr .95fr;gap:28px;align-items:center}.tag{color:#a7f3d0;font-size:10px;font-weight:900;letter-spacing:.16em}.hero h1{font-size:clamp(48px,7vw,88px);line-height:.9;letter-spacing:-.085em;margin:16px 0}.hero em{font-style:normal;background:linear-gradient(120deg,#c4b5fd,#5eead4);background-clip:text;color:transparent}p{color:var(--m);line-height:1.7}.glass{position:relative;overflow:hidden;border:1px solid #ffffff20;border-radius:24px;padding:22px;background:#171a32aa;backdrop-filter:blur(18px);box-shadow:0 28px 80px #0007}.orb{position:absolute;width:180px;height:180px;border-radius:50%;background:linear-gradient(135deg,#8b5cf6,#2dd4bf);filter:blur(18px);opacity:.22;right:-30px;top:-28px}.row{position:relative;display:flex;gap:10px;padding:13px;border:1px solid #ffffff12;border-radius:12px;margin-top:10px;background:#0a0c18aa}.dot{width:10px;height:10px;border-radius:50%;background:var(--c);box-shadow:0 0 18px var(--c);margin-top:4px}.sec{padding:74px 0;border-top:1px solid #ffffff12}.cards{display:grid;grid-template-columns:repeat(3,1fr);gap:14px}.card{border:1px solid #ffffff15;border-radius:18px;padding:20px;background:linear-gradient(145deg,#181b35,#101222)}.card small{color:#5eead4;font-weight:800}.card h3{margin:15px 0 5px}.motion{animation:float 5s ease-in-out infinite}.pulse{animation:pulse 2.4s ease-in-out infinite}@keyframes float{50%{transform:translateY(-9px)}}@keyframes pulse{50%{opacity:.45;transform:scale(.88)}}@media(prefers-reduced-motion:reduce){.motion,.pulse{animation:none}}@media(max-width:760px){.grid,.cards{grid-template-columns:1fr}.wrap{padding:0 16px}.nav a{display:none}}</style></head><body><div class="wrap nav"><div class="brand">Maqtomate</div><div><a href="/pricing">Pricing</a><a href="/login">Sign in</a><a class="btn" href="/connect">Plan rollout</a></div></div><main><section class="hero"><div class="wrap grid"><div><span class="tag">OFFICIAL WHATSAPP CLOUD API · MANAGED DEPLOYMENT</span><h1>Make WhatsApp feel <em>operational.</em></h1><p>A modern managed AI Employee experience for enquiry preparation, qualified lead context, human handoff, and secure official activation.</p><p><a class="btn" href="/connect">Plan your AI Employee</a> <a href="/signup" style="color:#c4b5fd;margin-left:12px">Create account</a></p></div><aside class="glass motion"><div class="orb pulse"></div><span class="tag">ACTIVATION SIGNAL</span><h2>Managed rollout status</h2><div class="row"><i class="dot"></i>Google identity and customer password</div><div class="row"><i class="dot"></i>Offer, payment review and readiness</div><div class="row"><i class="dot"></i>Customer-owned official connection</div><div class="row"><i class="dot"></i>Supervised go-live proof</div></aside></div></section><section class="sec"><div class="wrap"><span class="tag">OFFERS</span><h2>Clear price. Controlled activation.</h2><div class="cards"><article class="card"><small>MANAGED LAUNCH</small><h3>Rs 5,000 setup + Rs 2,000/month</h3><p>Context, qualification, human handoff and supervised readiness.</p></article><article class="card"><small>CUSTOM ROLLOUT</small><h3>Quote after review</h3><p>For complex workflows, language, volume or approved integrations.</p></article><article class="card"><small>CONNECTOR ROADMAP</small><h3>Gated by tenant, not hype</h3><p>CRM, Sheets, social channels and voice only through named, approved server-side connections.</p></article></div></div></section></main></body></html>`;
}
